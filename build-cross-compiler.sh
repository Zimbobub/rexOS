# borrowed (stolen) from https://github.com/mell-o-tron/MellOs/blob/main/A_Setup/setup-gcc-debian.sh
# runs on any debian derivative distro
...
make[1]: Leaving directory '/home/zimbobub/Desktop/projects/rexOS/cross-compiler/gcc'
